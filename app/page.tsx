      ...
      <main className="relative max-w-7xl mx-auto px-8 pb-32 pt-20">
        ...
        <section id="working" className="mb-40">
          ...
          <div className="relative">
            {/* Scroll Container */}
            <div className="overflow-x-auto pb-8 scrollbar-hide" style={{
              scrollbarWidth: 'none',
              ...
              <div className="flex gap-6 min-w-max px-4">
                ...
                <div className="w-80 flex-shrink-0">
                  <div className="bg-white/[0.01] backdrop-blur-lg border border-white/5 rounded-2xl p-10 h-full hover:border-white/10 hover:bg-white/[0.02] transition-all">
            ...
            {/* Scroll Indicator */}
            <div className="flex items-center gap-2 mt-6 text-white/30 text-sm font-light">
